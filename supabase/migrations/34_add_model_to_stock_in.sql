-- =================================================================
-- MIGRATION 34: ADD MODEL ("รุ่น") FIELD TO STOCK IN ITEMS & RPC
-- =================================================================

-- 1. Add model column to stock_in_items and items master table if not exists
ALTER TABLE public.stock_in_items ADD COLUMN IF NOT EXISTS model TEXT;
ALTER TABLE public.items ADD COLUMN IF NOT EXISTS model TEXT;

-- 2. Update Supabase RPC: process_stock_in to support model field
