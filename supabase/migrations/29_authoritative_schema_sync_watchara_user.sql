-- Migration 29: Authoritative Schema Sync for watchara.m@forth.co.th
-- Built strictly from the authoritative database schema definition (omitting generated columns confirmed_at and identities.email).
...
BEGIN
  ...
  -- 3. Insert into auth.users (email_confirmed_at set, confirmed_at is automatically generated)
  ...
  -- 4. Insert into auth.identities (identities.email is automatically generated from identity_data)
