...
fs.writeFileSync('supabase/migrations/61_complete_all_system_rpcs.sql', migration61Sql, 'utf8');
fs.writeFileSync('backups/04_all_system_rpcs_and_functions.sql', migration61Sql, 'utf8');
console.log('Saved clean 61_complete_all_system_rpcs.sql and backups/04_all_system_rpcs_and_functions.sql');
