...
const HistoryPagination = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 bg-card/60 backdrop-blur border border-border/60 rounded-2xl text-xs shadow-xs">
      {/* Items count summary */}
      <div className="flex items-center gap-3 text-muted-foreground font-medium">
        <span>
          ...
          <strong className="text-foreground font-bold">{totalItems.toLocaleString('th-TH')}</strong> รายการประวัติ
        </span>
      ...
      <div className="flex items-center gap-1">
        ...
        {getPageNumbers().map((page) => (
          <Button
            ...
            className={`h-8 w-8 p-0 rounded-lg font-bold text-xs cursor-pointer ${
              page === currentPage
